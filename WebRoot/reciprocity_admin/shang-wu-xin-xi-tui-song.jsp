...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="tablist">
			...
			<a href="${ctx}/home.action?operType=business_PushInfo" class="on">商务信息推送审核</a>
		</div>
		<form action="${ctx}/home.action" id="info_diss" method="post">
			<input type="hidden" name="operType" value="business_PushInfo">
			<div id="main">
				<div class="custom">
					<h4 class="hd">
						<span class="title">商务信息推送列表</span>
					</h4>
					<div class="hm">
						 ...
						 续费提醒
						  ...
						  未推送
						   ...
						   推送不成功
								...
								<td>
									<a
										href="${ctx}/home.action?operType=delete_clicent_PushInfo&recipient_type=2&push_info_id=${pushInfo.push_info_id}"
