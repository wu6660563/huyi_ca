...
public class Uploader {
	...
	public void upload() throws Exception {
		...
		try {
			String path = Configuration.read("fileupload.directory");
			String formaterDate = this.getFolder(path);
			String savePath = path + "/" + formaterDate;
			...
			this.url = formaterDate +"/" + this.fileName;
