...
public class CKEditorUploadServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String timeDir = sdf.format(new Date());
		if (debug)
		...
		// 获得web应用的上传路径
		String currentDirPath  = Configuration.read("fileupload.directory")+timeDir;
		...
		if (enabled) {
			...
			try {
				...
				fileUrl = fileUrl+timeDir+ fileName;
